...
export const FeedbackForm: React.FC<FeedbackFormProps> = ({ projectName, context, onFeedbackSubmitted }) => {
    ...
    if (submitted) {
        return (
            <div className="mt-4 p-4 border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20 rounded-lg flex items-center justify-between">
    ...
    return (
        <div className="mt-4 p-4 border border-gray-200 dark:border-slate-700 rounded-lg bg-gray-50 dark:bg-slate-800/50">
            <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Rate this result</h3>
            ...
            {rating && (
                <div className="space-y-3 animate-in fade-in slide-in-from-top-2 duration-200">
                    <textarea
                        ...
                        placeholder="Tell us more (how can we improve?)..."
                        className="w-full text-sm p-3 rounded-md border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400 dark:placeholder-gray-500"
                        rows={3}
                    />
