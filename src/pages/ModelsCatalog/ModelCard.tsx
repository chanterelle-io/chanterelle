...
const ModelCard: React.FC<ModelCardProps> = ({ model, onClick }) => (
    <div
        className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer flex flex-col justify-between"
        onClick={() => onClick(model)}
    >
        {/* <div className="flex flex-col items-center mb-4"> */}

        <div className="flex flex-row justify-center items-center bg-blue-900 rounded-t-lg mb-4">
